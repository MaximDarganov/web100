...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  if (!$hasErrors && !empty($_COOKIE[session_name()]) && !empty($_SESSION['login'])) {
    ...
    $user = 'u41611';
    $pass = '7131532';
    $db = new PDO('mysql:host=localhost;dbname=u41611', $user, $pass, array(PDO::ATTR_PERSISTENT => true));
...
// Иначе, если запрос был методом POST, т.е. нужно проверить данные и сохранить их в XML-файл.
  ...
  if (!empty($_COOKIE[session_name()]) &&
    ...
    $user = 'u41611';
    $pass_db = '7131532';
    $db = new PDO('mysql:host=localhost;dbname=u41611', $user, $pass_db, array(PDO::ATTR_PERSISTENT => true));
